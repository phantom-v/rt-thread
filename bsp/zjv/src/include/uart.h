...
#define UART_RHR   (0x00 * 4)  // Receiver Holding Register 
#define UART_THR   (0x00 * 4)  // Transmitter Holding Register 
#define UART_IER   (0x01 * 4)  // Interrupt Enable Register 
#define UART_ISR   (0x02 * 4)  // Interrupt Status Register
#define UART_FCR   (0x02 * 4)  // FIFO Control Register 
#define UART_LCR   (0x03 * 4)  // Line Control Register 
#define UART_MCR   (0x04 * 4)  // Modem Control Register 
#define UART_LSR   (0x05 * 4)  // Line Status Register 
#define UART_MSR   (0x06 * 4)  // Modem Status Register 
#define UART_SPR   (0x07 * 4)  // Scratch Pad Register 
#define UART_DLL   (0x00 * 4)  // Divisor LSB (LCR_DLAB) 
#define UART_DLM   (0x01 * 4)  // Divisor MSB (LCR_DLAB) 
#define UART_PSD   (0x05 * 4)  // Prescaler's Division Factor (LCR_DLAB) 
